...
#         publisher_command_commands[3].tau = 20.0
#         publisher_command_commands[6].tau = 20.0
#         publisher_command_commands[9].tau = 20.0

#         publisher_command_commands[2].tau = -20.0
#         publisher_command_commands[5].tau = -20.0
#         publisher_command_commands[8].tau = -20.0
#         publisher_command_commands[11].tau = -20.0

#         joint_publishers[joint_name[0]].publish(publisher_command_commands[0])
#         joint_publishers[joint_name[1]].publish(publisher_command_commands[1])
#         joint_publishers[joint_name[2]].publish(publisher_command_commands[2])
#         joint_publishers[joint_name[3]].publish(publisher_command_commands[3])
#         joint_publishers[joint_name[4]].publish(publisher_command_commands[4])
#         joint_publishers[joint_name[5]].publish(publisher_command_commands[5])
#         joint_publishers[joint_name[6]].publish(publisher_command_commands[6])
#         joint_publishers[joint_name[7]].publish(publisher_command_commands[7])
#         joint_publishers[joint_name[8]].publish(publisher_command_commands[8])
#         joint_publishers[joint_name[9]].publish(publisher_command_commands[9])
#         joint_publishers[joint_name[10]].publish(publisher_command_commands[10])
#         joint_publishers[joint_name[11]].publish(publisher_command_commands[11])

        # if state.motor_state.p[0] > -0.4:
        #     publisher_command_commands[0].tau = 0.0
        # if state.motor_state.p[3] > -0.4:
        #     publisher_command_commands[3].tau = 0.0
        # if state.motor_state.p[6] > -0.4:
        #     publisher_command_commands[6].tau = 0.0
        # if state.motor_state.p[9] > -0.4:
        #     publisher_command_commands[9].tau = 0.0

        # if state.motor_state.p[2] < 0.5:
        #     publisher_command_commands[2].tau = 0.0
        # if state.motor_state.p[5] < 0.5:
        #     publisher_command_commands[5].tau = 0.0
        # if state.motor_state.p[8] < 0.5:
        #     publisher_command_commands[8].tau = 0.0
        # if state.motor_state.p[11] < 0.5:
        #     publisher_command_commands[11].tau = 0.0
...
if __name__ == "__main__":
    ...
    # Sub ContactForce
    FLContactSubscriber = rospy.Subscriber("/FL_contact",WrenchStamped,FLContactCallback,queue_size=10)
    FRContactSubscriber = rospy.Subscriber("/FR_contact",WrenchStamped,FRContactCallback,queue_size=10)
    RLContactSubscriber = rospy.Subscriber("/RL_contact",WrenchStamped,RLContactCallback,queue_size=10)
    RRContactSubscriber = rospy.Subscriber("/RR_contact",WrenchStamped,RRContactCallback,queue_size=10)
    # Sub IMU
